...
idCVar r_useTesselation( "r_useTesselation", "0", CVAR_RENDERER | CVAR_BOOL, "use tesselation if available" );
...
idCVar r_skipDisplacement( "r_skipDisplacement", "0", CVAR_RENDERER | CVAR_BOOL | CVAR_ARCHIVE, "uses a flat surface instead of the displacement map" );
...
static void R_CheckPortableExtensions( void ) {
	...
	if ( glConfig.multitextureAvailable ) {
		...
		qglGetIntegerv( GL_MAX_TEXTURE_UNITS, (GLint *)&glConfig.maxTextureUnits );
...
static void GfxInfo_f( const idCmdArgs &args ) {
	...
	common->Printf( "GL_MAX_TEXTURE_COORDS: %d\n", glConfig.maxTextureCoords );
	common->Printf( "GL_MAX_TEXTURE_IMAGE_UNITS: %d\n", glConfig.maxTextureImageUnits );
